...
abstract class GASRHT001_Event {}

class GASRHT001_READ extends GASRHT001_Event {}

class GASRHT001_Bloc extends Bloc<GASRHT001_Event, GASRHT001SCHEMA> {
  GASRHT001_Bloc()
      : super(GASRHT001SCHEMA(
          ItemPick: [''],
    ...
    on<GASRHT001_READ>((event, emit) {
      return _GASRHT001_READ(
          GASRHT001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASRHT001_READ(
      GASRHT001SCHEMA toAdd, Emitter<GASRHT001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASRHT001db",
      data: {},
    );
    GASRHT001SCHEMA output = GASRHT001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
