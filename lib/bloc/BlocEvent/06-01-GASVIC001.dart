...
abstract class GASVIC001_Event {}

class GASVIC001_READ extends GASVIC001_Event {}

class GASVIC001_Bloc extends Bloc<GASVIC001_Event, GASVIC001SCHEMA> {
  GASVIC001_Bloc()
      : super(GASVIC001SCHEMA(
          ItemPick: [''],
    ...
    on<GASVIC001_READ>((event, emit) {
      return _GASVIC001_READ(
          GASVIC001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASVIC001_READ(
      GASVIC001SCHEMA toAdd, Emitter<GASVIC001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASVIC001db",
      data: {},
    );
    GASVIC001SCHEMA output = GASVIC001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
