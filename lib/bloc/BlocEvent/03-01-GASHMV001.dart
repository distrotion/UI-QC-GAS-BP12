...
abstract class GASHMV001_Event {}

class GASHMV001_READ extends GASHMV001_Event {}

class GASHMV001_Bloc extends Bloc<GASHMV001_Event, GASHMV001SCHEMA> {
  GASHMV001_Bloc()
      : super(GASHMV001SCHEMA(
          ItemPick: [''],
    ...
    on<GASHMV001_READ>((event, emit) {
      return _GASHMV001_READ(
          GASHMV001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASHMV001_READ(
      GASHMV001SCHEMA toAdd, Emitter<GASHMV001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASHMV001db",
      data: {},
    );
    GASHMV001SCHEMA output = GASHMV001SCHEMA(
      Pic: "",
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
