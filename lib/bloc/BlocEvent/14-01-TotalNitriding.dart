...
abstract class TotalNitriding_Event {}

class TotalNitriding_READ extends TotalNitriding_Event {}

class TotalNitriding_Bloc
    extends Bloc<TotalNitriding_Event, TotalNitridingSCHEMA> {
  TotalNitriding_Bloc()
      : super(TotalNitridingSCHEMA(
          ItemPick: [''],
    ...
    on<TotalNitriding_READ>((event, emit) {
      return _TotalNitriding_READ(
          TotalNitridingSCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
            confirmdata: [],
  ...
  Future<void> _TotalNitriding_READ(
      TotalNitridingSCHEMA toAdd, Emitter<TotalNitridingSCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "TotalNitridingdb",
      data: {},
    );
    TotalNitridingSCHEMA output = TotalNitridingSCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
