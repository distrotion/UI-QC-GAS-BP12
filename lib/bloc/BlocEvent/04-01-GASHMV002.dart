...
abstract class GASHMV002_Event {}

class GASHMV002_READ extends GASHMV002_Event {}

class GASHMV002_Bloc extends Bloc<GASHMV002_Event, GASHMV002SCHEMA> {
  GASHMV002_Bloc()
      : super(GASHMV002SCHEMA(
          ItemPick: [''],
    ...
    on<GASHMV002_READ>((event, emit) {
      return _GASHMV002_READ(
          GASHMV002SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASHMV002_READ(
      GASHMV002SCHEMA toAdd, Emitter<GASHMV002SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASHMV002db",
      data: {},
    );
    GASHMV002SCHEMA output = GASHMV002SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
