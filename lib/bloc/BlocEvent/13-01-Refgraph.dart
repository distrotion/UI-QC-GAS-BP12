...
abstract class Refgraph_Event {}

class Refgraph_READ extends Refgraph_Event {}

class Refgraph_Bloc extends Bloc<Refgraph_Event, RefgraphSCHEMA> {
  Refgraph_Bloc()
      : super(RefgraphSCHEMA(
          ItemPick: [''],
    ...
    on<Refgraph_READ>((event, emit) {
      return _Refgraph_READ(
          RefgraphSCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _Refgraph_READ(
      RefgraphSCHEMA toAdd, Emitter<RefgraphSCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "Refgraphdb",
      data: {},
    );
    RefgraphSCHEMA output = RefgraphSCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
