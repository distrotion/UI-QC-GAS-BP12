...
abstract class GASHMV003_Event {}

class GASHMV003_READ extends GASHMV003_Event {}

class GASHMV003_Bloc extends Bloc<GASHMV003_Event, GASHMV003SCHEMA> {
  GASHMV003_Bloc()
      : super(GASHMV003SCHEMA(
          ItemPick: [''],
    ...
    on<GASHMV003_READ>((event, emit) {
      return _GASHMV003_READ(
          GASHMV003SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASHMV003_READ(
      GASHMV003SCHEMA toAdd, Emitter<GASHMV003SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASHMV003db",
      data: {},
    );
    GASHMV003SCHEMA output = GASHMV003SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
