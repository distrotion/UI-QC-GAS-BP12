...
import '../page303.dart';
import 'ReportPDFCommonvarALL.dart';

late BuildContext ReportPDFCommoncontext;

class ReportPDFCommonNEW extends StatefulWidget {
  ReportPDFCommonNEW({Key? key, this.dataCommon}) : super(key: key);
  CommonReportOutput? dataCommon;
  @override
  State<ReportPDFCommonNEW> createState() => _ReportPDFCommonNEWState();
}

class _ReportPDFCommonNEWState extends State<ReportPDFCommonNEW> {
  @override
  void initState() {
    ReportPDFCommonvar.TPKLOTEDIT = '';
    if (ReportPDFCommonvar.PO != '') {
      ReportPDFCommonvar.canf = false;
      context.read<ReportPDFCommon_Cubit>().ReportPDFCommonCubit(
  ...
  Widget build(BuildContext context) {
    ...
    CommonReportOutput _dataCOMMON =
        widget.dataCommon ?? CommonReportOutput(databasic: BasicCommonDATA());
    int HardnessNO = 1;
    int CoreNO = 1;
    int GraphNO = 1;
    int CompoundNO = 1;
    ...
    if (_dataCOMMON.datain.isNotEmpty) {
      ...
      for (var i = 0; i < _dataCOMMON.datain.length; i++) {
        ...
        if (_dataCOMMON.datain[i].TYPE == 'Number') {
          if (_dataCOMMON.datain[i].ITEMname.toUpperCase().contains(
                'HARDNESS',
              ) &&
            ...
            for (
              ...
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 1) {
                ReportPDFCommonvar.rawlistHardness.add(
                  rawlist(
          ...
          } else if (_dataCOMMON.datain[i].ITEMname.toUpperCase().contains(
            'CORE',
          )) {
            for (
              var li = 0;
              ...
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX == 0) {}
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 1) {
                ReportPDFCommonvar.rawlistCORE.add(
                  rawlist(
        ...
        if (_dataCOMMON.datain[i].TYPE == 'Graph') {
          ...
          if (_dataCOMMON.datain[i].ITEMname.contains('Hardness') ||
              ...
              _dataCOMMON.datain[i].ITEMname.contains('Case Depth') ||
          ...
          //
            ...
            for (
              ...
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX == 0) {}
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 1) {
                ReportPDFCommonvar.rawlistGraph.add(
                  rawlist(
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA01),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 2) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA02),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 3) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA03),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 4) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA04),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 5) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA05),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 6) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA06),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 7) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA07),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 8) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA08),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 9) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA09),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 10) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA10),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 11) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA11),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 12) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA12),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 13) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA13),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 14) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA14),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 15) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA15),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 16) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA16),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 17) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA17),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 18) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA18),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 19) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA19),
                    ),
                  ),
                );
              }
              if (_dataCOMMON.datain[i].datapackset[li].dimensionX >= 20) {
                ...
                ReportPDFCommonvar.graphdata.add(
                  FlSpot(
                    ...
                    double.parse(
                      ConverstStr(_dataCOMMON.datain[i].datapackset[li].DATA20),
                    ),
                  ),
                );
              }
          ...
          if (ReportPDFCommonvar.rawlistGraph.length > 2) {
            ...
            ReportPDFCommonvar.rawlistGraph.removeAt(
              ReportPDFCommonvar.rawlistGraph.length - 1,
            );
          }
          ...
          ReportPDFCommonvar.graphupper = [
            ...
            FlSpot(
              ReportPDFCommonvar
                  .graphdata[ReportPDFCommonvar.graphdata.length - 2]
                  .x,
              1000,
            ),
          ];
          ...
          ReportPDFCommonvar.graphdata2 = [
            FlSpot(
              ReportPDFCommonvar.graphdata[0].x,
              double.parse(ConverstStr(_dataCOMMON.datain[i].Cross)),
            ),
            FlSpot(
              double.parse(ConverstStr(_dataCOMMON.datain[i].RESULT)),
              double.parse(ConverstStr(_dataCOMMON.datain[i].Cross)),
            ),
          ];
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  height: 40,
                  width: 200,
                  child: Center(child: Text(ReportPDFCommonvar.STATUS)),
                ),
              ),
              Padding(
                padding: const EdgeInsets.only(left: 30),
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    height: 50,
                    width: 100,
                    child: const Center(child: Text("UD and QCFN")),
                  ),
                ),
              ),
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    height: 50,
                    width: 100,
                    child: const Center(child: Text("_QCFN")),
                  ),
                ),
              ),
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    Dio().post(server + sap, data: {}).then((v) {
                      //
                      var databuff = v.data;
                  ...
                  child: Container(
                    ...
                    height: 50,
                    width: 100,
                    child: const Center(child: Text("Re Lot")),
                  ),
                ),
              ),
              Container(
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            height: 50,
                            width: 100,
                            child: const Center(child: Text("Re Graph")),
                          ),
                        ),
                      ),
                    ],
          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  //   NAME02: "Kritsada",
                                  //   NAME03: "Kritsada",
                                  //   NAME01date: DateFormat('dd').format(now) +
                                  //       '/' +
                                  //       DateFormat('MM').format(now) +
                                  //       '/' +
                                  //       DateFormat('yyyy').format(now),
                                  //   NAME02date: DateFormat('dd').format(now) +
                                  //       '/' +
                                  //       DateFormat('MM').format(now) +
                                  //       '/' +
                                  //       DateFormat('yyyy').format(now),
                                  //   NAME03date: DateFormat('dd').format(now) +
                                  //       '/' +
                                  //       DateFormat('MM').format(now) +
                                  //       '/' +
                                  //       DateFormat('yyyy').format(now),
                                  ...
                                  TAILSLOT(
                                    ...
                                    NAME03: _dataCOMMON.databasic.Approve_sign,
                                    NAME01date:
                                        _dataCOMMON.databasic.dateInspected !=
                                            ''
                                        ? DateFormat('dd/MM/yyyy').format(
                                            DateTime.fromMillisecondsSinceEpoch(
                                              int.parse(
                                        ...
                                        : "",
                                    NAME02date:
                                        _dataCOMMON.databasic.dateCheck != ''
                                        ? DateFormat('dd/MM/yyyy').format(
                                            DateTime.fromMillisecondsSinceEpoch(
                                              int.parse(
                                                ConverstStr(
                                        ...
                                        : "",
                                    NAME03date:
                                        _dataCOMMON.databasic.dateApprove != ''
                                        ? DateFormat('dd/MM/yyyy').format(
                                            DateTime.fromMillisecondsSinceEpoch(
                                              int.parse(
                                                ConverstStr(
                ...
                //                 ? Colors.blue
                //                 : Colors.red,
                //             child: Center(child: Text("Inspected")),
                //           ),
                //         ),
                //       ),
                //     ],
