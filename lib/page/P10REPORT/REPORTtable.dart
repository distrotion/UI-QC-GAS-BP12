...
class _REPORTuiBODYState extends State<REPORTuiBODY> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.ret == 'get') {
      ...
      //     'http://172.101.33.151/ReportServer?%2fReport+Project4%2fHESISN-STD&rs:Format=PDF&rs:Command=Render&PO=${REPORTvar.PO}'
      //   ]);
      ...
      //   js.context.callMethod('open', [
      //     'http://172.101.33.151/ReportServer?%2fReport+Project4%2fHESISN-ACTN&rs:Format=PDF&rs:Command=Render&PO=${REPORTvar.PO}'
      //   ]);
      //   context.read<REPORT_CALL_Bloc>().add(REPORT_CALL_FLUSH());
      //   widget.ret = '';
      //   // REPORTvar.PO = '';
      ...
      // } else {
      //   js.context.callMethod('open', [
      //     'http://172.101.33.151/ReportServer?%2fReport+Project4%2fHESISN-COMMON1&rs:Format=PDF&rs:Command=Render&PO=${REPORTvar.PO}'
      //   ]);
      //   context.read<REPORT_CALL_Bloc>().add(REPORT_CALL_FLUSH());
      //   widget.ret = '';
      //   // REPORTvar.PO = '';
