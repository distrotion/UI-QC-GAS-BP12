  ...
  void initState() {
    ...
    if (ReportPDF2GPvar.PO != '') {
      ...
      context
          ...
          .ReportPDFCommonCubit(ReportPDF2GPvar.PO);
    }
    super.initState();
  }
                          ...
                          child: Column(
                            children: [
                              ...
                              BODY7SLOT(
                                ...
                                widget02: Center(
                                  child: ReportPDF2GPvar.datalist[0].SCMARK ==
                                          'YES'
                                      ? PicShow(
                                          width: 42,
                                          height: 42,
                                          base64: ReportPDF2GPvar.SCMASKTYPE)
                                      : const Text(
                                          "",
                                          style: TextStyle(
                                            fontSize: 16,
                              ...
                              BODY7SLOT(
                                ...
                                widget02: Center(
                                  child: ReportPDF2GPvar.datalist[1].SCMARK ==
                                          'YES'
                                      ? PicShow(
                                          width: 42,
                                          height: 42,
                              ...
                              BODY7SLOT(
                                ...
                                widget02: Center(
                                  child: ReportPDF2GPvar.datalist[2].SCMARK ==
                                          'YES'
                                      ? PicShow(
                                          width: 42,
                                          height: 42,
                              ...
                              BODY7SLOT(
                                ...
                                widget02: Center(
                                  child: ReportPDF2GPvar.datalist[3].SCMARK ==
                                          'YES'
                                      ? PicShow(
                                          width: 42,
                                          height: 42,
                              ...
                              BODY7SLOT(
                                ...
                                widget02: Center(
                                  child: ReportPDF2GPvar.datalist[4].SCMARK ==
                                          'YES'
                                      ? PicShow(
                                          width: 42,
                                          height: 42,
                              ...
                              BODY7SLOT(
                                ...
                                widget02: Center(
                                  child: ReportPDF2GPvar.datalist[5].SCMARK ==
                                          'YES'
                                      ? PicShow(
                                          width: 42,
                                          height: 42,
                              ...
                              //   ),
                              //   widget02: Center(
                              //     child: ReportPDF2GPvar.datalist[6].SCMARK ==
                              //             'YES'
                              //         ? PicShow(
                              //             width: 42,
                              //             height: 42,
                                      ...
                                      child: Container(
                                        ...
                                        child: ReportPDF2GPvar
                                            ...
                                            ? ControlChart01(
                                                upper:
                                                    ReportPDF2GPvar.graphupper,
                                                data: ReportPDF2GPvar.graphdata,
                                                data2:
                                                    ReportPDF2GPvar.graphdata2,
                                                data3:
                                                    ReportPDF2GPvar.graphdata3,
                                ...
                                widget03: Column(
                                  children: [
                                    HEAD16SLOT(
                                      ...
                                      widget02: Center(
                                        child: Text(
                                          ReportPDF2GPvar.rawlistGraph.length >=
                                                  1
                                              ? ReportPDF2GPvar
                                    ...
                                    BODY16SLOT(
                                      ...
                                      widget16: Center(
                                        child: Text(
                                          ReportPDF2GPvar.rawlistGraphCore.DATA,
                                          style: const TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.bold,
                                          ),
                              ...
                              TAILSLOT(
                                ...
                                NAME01: ReportPDF2GPvar.SignInsBy,
                                NAME02: "",
                                NAME03: "",
                              ),
                            ],
